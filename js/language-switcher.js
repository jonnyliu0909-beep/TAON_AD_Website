(function(){
  ...
  "en": {
    ...
    "about.p2": "Today, we have expanded to Toronto, opening a new studio to serve the local market while maintaining our global perspective. This expansion allows us to combine international expertise with a deep understanding of local audiences, providing tailored strategies for brands seeking both creativity and impact.",
  ...
  "zh": {
    ...
    "about.p2": "如今，我们已扩展至多伦多，开设新工作室服务本地市场，同时保持全球视野。这一扩展使我们能够将国际专业知识与对本地受众的深入了解相结合，为寻求创意和影响力的品牌提供量身定制的策略。",
  ...
  "zh-hant": {
    ...
    "about.p2": "如今，我們已擴展至多倫多，開設新工作室服務本地市場，同時保持全球視野。這一擴展使我們能夠將國際專業知識與對本地受眾的深入了解相結合，為尋求創意和影響力的品牌提供量身定製的策略。",
  ...
  "fr": {
    ...
    "about.p2": "Aujourd'hui, nous nous sommes étendus à Toronto, ouvrant un nouveau studio pour servir le marché local tout en maintenant notre perspective mondiale. Cette expansion nous permet de combiner l'expertise internationale avec une compréhension approfondie des publics locaux, offrant des stratégies sur mesure aux marques recherchant à la fois créativité et impact.",
  ...
  "es": {
    ...
    "about.p2": "Hoy nos hemos expandido a Toronto, abriendo un nuevo estudio para atender al mercado local sin perder nuestra perspectiva global. Esta expansión nos permite combinar experiencia internacional con un profundo conocimiento del público local, ofreciendo estrategias a medida para marcas que buscan creatividad e impacto.",
  ...
  "ja": {
    ...
    "about.p2": "現在はトロントにも拡大し、グローバルな視点を保ちながらローカル市場に向けた新スタジオを開設しました。この拡張により、国際的な知見と地域の深い理解を組み合わせ、創造性とインパクトを求めるブランドに合わせた戦略を提供しています。",
  ...
  "ko": {
    ...
    "about.p2": "오늘날 우리는 토론토로 확장하여 글로벌 관점을 유지하면서 현지 시장을 서비스하는 새로운 스튜디오를 열었습니다. 이 확장을 통해 국제적 전문성과 현지 청중에 대한 깊은 이해를 결합하여 창의성과 영향력을 모두 추구하는 브랜드를 위한 맞춤형 전략을 제공합니다.",
